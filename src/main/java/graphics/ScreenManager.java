...
{
	private static ScreenManager screen = null;
	...
	public DisplayMode findFirstCompatibleMode(DisplayMode modes[])
	{
		...
		for (int i = 0; i < modes.length; i++)
		{
			...
			{
				if (displayModesMatch(modes[i], goodModes[j])) { return modes[i]; }
			}
...

	{
		if (mode1.getWidth() != mode2.getWidth()
				|| mode1.getHeight() != mode2.getHeight()) { return false; }

		if (mode1.getBitDepth() != DisplayMode.BIT_DEPTH_MULTI
				&& mode2.getBitDepth() != DisplayMode.BIT_DEPTH_MULTI
				&& mode1.getBitDepth() != mode2.getBitDepth()) { return false; }

		if (mode1.getRefreshRate() != DisplayMode.REFRESH_RATE_UNKNOWN
				&& mode2.getRefreshRate() != DisplayMode.REFRESH_RATE_UNKNOWN
				&& mode1.getRefreshRate() != mode2.getRefreshRate()) { return false; }
	 ...
	 */
	public void setFullScreen(DisplayMode displayMode, boolean fullscreen)
	{
	 ...
	 */
	public JFrame getScreenWindow()
	{
		/*JFrame window = (JFrame) device.getFullScreenWindow();
		if(window != null)
		{
			return window;
		}*/
